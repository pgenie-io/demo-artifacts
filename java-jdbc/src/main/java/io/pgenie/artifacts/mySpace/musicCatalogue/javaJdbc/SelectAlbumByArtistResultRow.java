...
public final class SelectAlbumByArtistResultRow implements Comparable<SelectAlbumByArtistResultRow> {
  public final long id;
  public final String name;
  public final Optional<Date> released;

  SelectAlbumByArtistResultRow(long id, String name, Optional<Date> released) {
    this.id = id;
    this.name = name;
  ...
  public boolean equals(Object that) {
    return that instanceof SelectAlbumByArtistResultRow && equals((SelectAlbumByArtistResultRow) that);
  }
  /**
   ...
   */
  public boolean equals(SelectAlbumByArtistResultRow that) {
    return
      id == that.id &&
  ...
  public int hashCode() {
    int hash = SelectAlbumByArtistResultRow.class.hashCode();
  ...
  public int compareTo(SelectAlbumByArtistResultRow that) {
    int status;
